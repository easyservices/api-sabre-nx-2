        ...
        for component in calendar.walk():
            if component.name == "VEVENT":
                try:
                    ...
                    classification = str(class_value).upper() if class_value else "PUBLIC"
...
def event_to_ical(event: Event) -> str:
    ...
    # Add classification/privacy level (default to PUBLIC)
    classification_value = (event.classification or "PUBLIC").upper()
    vevent.add('class', classification_value)
